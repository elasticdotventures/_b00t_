...
export default defineConfig((/* ctx */) => {
  return {
    ...
    build: {
      ...
      // CSP: allow CDN scripts (mermaid.js, cytoscape.js) and API connections
      html: {
        'http-equiv': {
          'http-equiv': 'Content-Security-Policy',
          'content': "default-src 'self' https://cdn.jsdelivr.net; script-src 'self' https://cdn.jsdelivr.net 'unsafe-inline'; style-src 'self' 'unsafe-inline'; connect-src 'self' http://localhost:* ws://localhost:*; img-src 'self' data: blob:;"
        }
      },
      // vueRouterBase,
      // vueDevtools,
