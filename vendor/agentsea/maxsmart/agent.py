...
class maxsmartConfig(BaseModel):
    pass


class maxsmart(TaskAgent):
    ...
    @classmethod
    def config_type(cls) -> Type[maxsmartConfig]:
        """Type of config

        Returns:
            Type[DinoConfig]: Config type
        """
        return maxsmartConfig

    @classmethod
    def from_config(cls, config: maxsmartConfig) -> "maxsmart":
