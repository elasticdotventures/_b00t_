...
models = b00t_pyverse.list_ai_models("~/.dotfiles/_b00t_")
```
...
```bash
# Via Python
python3 -c "import b00t_pyverse; print(b00t_pyverse.list_ai_providers('~/.dotfiles/_b00t_'))"
...
- **PyO3 bindings**: `b00t-pyverse/src/lib.rs` (Rust functions exposed to Python)
...
- `b00t-pyverse/src/lib.rs` - PyO3 bindings
