...
- ✅ G0spell at `~/.b00t` (from elasticdotventures/dotfiles)
...
## Step 5: Build Claude G0spell Agent (Optional)
...
```bash
cd ~/homeassistant/_b00t_/node-ts.🦄
source claude.🐳/env.sh  # Symlink to g0spell
claude
```
