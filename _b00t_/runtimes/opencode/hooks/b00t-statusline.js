...
// Source: _b00t_/runtimes/hooks-src/b00t-statusline.ts
...
var safeSessionId = sessionId.replace(/[^A-Za-z0-9_-]/g, "_");
var bridgeFile = path.join("/tmp", `b00t-ctx-${safeSessionId}.json`);
try {
