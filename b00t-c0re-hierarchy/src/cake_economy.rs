...
impl CakeLedger {
    ...
    pub fn with_history(transactions: Vec<CakeTransaction>) -> Self {
...
mod tests {
    ...
    fn test_with_history_reconstructs_supply() {
        ...
        let ledger = CakeLedger::with_history(txs);
